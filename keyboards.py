...
from config import URL_MACBOOK, URL_IPHONE13, URL_iPad
...
keyboard1 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(text='iPad', callback_data='buy:2:iPad:56758')
        ],
        [
...
iPad_key = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton('Купить', url=URL_iPad)
        ]
    ]
)