...
from keyboards import keyboard, keyboard1, phone_key, mac_key, iPad_key, cb
...
async def get_goods(message: Message):
    # Убираем клавиатуру и выводим название нажатой кнопки
...
@dp.callback_query_handler(text_contains='iPad')
async def iPad(call: CallbackQuery):
    await call.answer(cache_time=60)
    await call.message.answer('Купить', reply_markup=iPad_key)
# 
